...
detailedReviewOnSuccess = function (response, status, xhr){
    ...
    for(var r in reviews){
        ...
        for(var j = 0; j  < review.productReviewDTOs.length ; j++){
            ...
            panel_heading.innerText = "User ID : " + review.productReviewDTOs[j].reviewerID;

            var span1 = document.createElement('span');
            span1.className = "pull-right";
            span1.innerText = "Review Date : " + review.productReviewDTOs[j].reviewDate;
            ...
            span2.innerText = review.productReviewDTOs[j].overallRating;
            ...
            for(var i = 0; i < review.productReviewDTOs[j].featureDTOList.length; i++){
                ...
                span4.innerText = review.productReviewDTOs[j].featureDTOList[i].featureName;

                var strong = document.createElement('strong');
                strong.className = "pull-right";
                strong.innerText = review.productReviewDTOs[j].featureDTOList[i].overallRating;
                ...
                var ratings = review.productReviewDTOs[j].featureDTOList[i].overallRating;
